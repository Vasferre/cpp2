...
PmergeMe::PmergeMe(int argc, char *argv[])
{
    ...
    std::cout << "Time to process a range of " << _vec.size() << " elements with std::vector: " << time << std::endl;
    ...
    std::cout << "Time to process a range of " << _deque.size() << " elements with std::deque: " << time << std::endl;
}
